...
# MONGODB_CONNECTION_STRING = 'mongodb://test:sparta@ac-o9du2mt-shard-00-00.zf3qmjc.mongodb.net:27017,ac-o9du2mt-shard-00-01.zf3qmjc.mongodb.net:27017,ac-o9du2mt-shard-00-02.zf3qmjc.mongodb.net:27017/?ssl=true&replicaSet=atlas-q0n3dd-shard-0&authSource=admin&retryWrites=true&w=majority&appName=AtlasApp'
...
def get_posts():
    ...
    try:
        ...
        usernam_receive = request.args.get('username_give')
        if usernam_receive == '':
            posts = list(db.posts.find({}).sort('date', -1).limit(20))
        else: 
            posts = list(db.posts.find({'username':usernam_receive}).sort('date', -1).limit(20))
        for post in posts:
        ...
        return jsonify({
            'result': 'success',
            'msg': 'Succeccfully fetched all posts!',
            'posts': posts
        })
    except (jwt.ExpiredSignatureError, jwt.exceptions.DecodeError):
        return redirect(url_for('home'))
